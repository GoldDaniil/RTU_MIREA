public class Loan {
    ...
    public void setAnnualInterestRate(double annualInterestRate) {
        if (annualInterestRate <= 0) {
            throw new IllegalArgumentException("uодовая процентная ставка должна быть больше 0");
        }
        this.annualInterestRate = annualInterestRate;
    }
    ...
    public void setNumberOfYears(int numberOfYears) {
        if (numberOfYears <= 0) {
            throw new IllegalArgumentException("cрок кредита должен быть больше 0");
        }
        this.numberOfYears = numberOfYears;
    }
    ...
    public void setLoanAmount(double loanAmount) {
        if (loanAmount <= 0) {
            throw new IllegalArgumentException("cумма кредита должна быть больше 0");
        }
        this.loanAmount = loanAmount;
    }
