...
class ShellGUI:
    def __init__(self, root, shell):
        ...
        self.root.configure(bg='#2e2e2e')#фон и стиль
        ...
        self.output_text.config(state=tk.DISABLED)#заперт редактирование

        self.input_frame = tk.Frame(root, bg='#2e2e2e', padx=10, pady=10)#gанель для ввода
