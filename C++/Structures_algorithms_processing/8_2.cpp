...
int main() {
    ...
    std::cout << "\n\nрезультаты: " << "\nдинамическое программирование (снизу вверх): сумма чисел = " << dp_result
        << " \nметод грубой силы - рекурсивный brute_force: сумма чисел = " << brute_force_result
        << " \nмаксимум из четырех возможных чисел (соседей на уровне и следующем уровне): сумма чисел = "
        << custom_result << " \nсверху вниз - c вершины треугольника итеративно добавляем значения к двум ближайшим элементам на след уровне: сумма чисел = "
        << top_down_result << " \n\n";

    std::cout << "\nпереборы: " << "\nдинамическое программирование (снизу вверх): " << dp_count 
        << " итераций\nметод грубой силы - рекурсивный brute_force: " << brute_force_count 
        << " итераций\nмаксимум из четырех возможных чисел (соседей на уровне и следующем уровне): " 
        << custom_count << " итераций\nсверху вниз - c вершины треугольника итеративно добавляем значения к двум ближайшим элементам на след уровне: "
        << top_down_count << " итераций";
