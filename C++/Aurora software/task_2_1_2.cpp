...
public:
    Triangle(int first_side_value, int second_side_value, int third_side_value) : side_one(first_side_value), side_two(second_side_value), side_three(third_side_value) {}
