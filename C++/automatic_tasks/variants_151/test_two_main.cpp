...
char predator_symbol_young;
//char predator_symbol_young = 'p';

char predator_symbol_old;
//char predator_symbol_old = 'P';

char herbivore_symbol_young;
//char herbivore_symbol_young = 'h';

char herbivore_symbol_old;
...
char mountain_symbol;
//char mountain_symbol = '^';

int mountain_population;
...
int herbivore_population;
//int herbivore_population = 1200;

int grass_population;
//int grass_population = 4000; // количество травы

// не трогать
double grass_regrowth_rate_summer = 0.031; // вероятность восстанавливаемости травы летом 
double grass_regrowth_rate_springfall = 0.0155; // вероятность восстанавливаемости травы осенью и весной 
double grass_regrowth_rate_winter = 0.0; // вероятность восстанавливаемости травы зимой 
double current_temperature = 20.0; // начальная температура
// не трогать

double death_probability_per_step;
//double death_probability_per_step = 0.1;

double tsunami_probability;
//double tsunami_probability = 0.3; // вероятность цунами

int young_herbivore_hunger_threshold;
//int young_herbivore_hunger_threshold = 3; // сколько шагов молодое травоядное животное может пройти без еды

int young_predator_hunger_threshold;
//int young_predator_hunger_threshold = 3; // сколько шагов молодой хищник может пройти без еды

int old_herbivore_hunger_threshold;
//int old_herbivore_hunger_threshold = 6; // сколько шагов старое травоядное животное может пройти без еды

int old_predator_hunger_threshold;
//int old_predator_hunger_threshold = 6; // сколько шагов старый хищник может пройти без еды

int predator_starvation_threshold;
//int predator_starvation_threshold = 4; // сколько шагов хищник может пройти без еды
...
void placeRandomMountains(Animal**& grid, int mountainCount) {
    int count = 0;
...
void initializeGrid(Animal**& grid) {
...
void printGrid(const Animal**& grid, int herbivore_count, int predator_count,
...
void countAnimals(const Animal**& grid, int& herbivore_count, int& predator_count,
    int& young_herbivore_count, int& young_predator_count, int& old_herbivore_count, int& old_predator_count) {
    herbivore_count = 0;
    predator_count = 0;
...
bool isAdjacent(int x1, int y1, int x2, int y2, const Animal**& grid) {
...
void countYoungAnimals(const Animal**& grid, int& young_herbivore_count, int& young_predator_count) {
    young_herbivore_count = 0;
    young_predator_count = 0;
...
void checkStarvation(Animal**& grid, int& herbivore_count, int& predator_count, int& dead_herbivore_count,
