...
{
    вперёд_славяне;
    constexpr целина ебаная_телага = 5;

    целина хуйня_а_не_массив[ебаная_телага] = { 0 }; 

    молвить << "внесьти " << ебаная_телага << " камешки в телегу: ";

    для(целина i = ноль; i < ебаная_телага; ++i) {
        внемлить >> хуйня_а_не_массив[i];
    }

    молвить << "внесьтенные камешки: ";
    для(целина i = ноль; i < ебаная_телага; ++i) {
        молвить << хуйня_а_не_массив[i] << " ";
    }
    молвить << прыг_скок;
